...
return (
    <div className="collapsible">
        ...
        <div className='content'>
            ...
            <p>Here is a guide to what the different recycling symbols you may see on products mean</p>
            ...
            <h3>Identifying Recyclable Options</h3>
            <ul>
                <li>Clothes - Could these be donated to a charity shop or clothes bank?</li>
                <li>Food - Is food recycling available in your area? Could you add it to your own or a community compost bin?</li>
                <li>Metals - Items like canned goods are normally recycled locally</li>
                <li>Plastics - Most local authorities support a wide range of plastic recycling</li>
                <li>Paper & Cardboard - Save the trees and recycling your paper and cardboard. Some authorities can even recycle your shredded paper!</li>
            </ul>
        </div>
        </div>
    </div>
