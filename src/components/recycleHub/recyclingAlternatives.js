...
return (
    <div className="collapsible">
        ...
        <div className='content'>
            ...
            <iframe width="85%" height="315" src="https://www.youtube-nocookie.com/embed/0v7f0KeNpv8?si=nmmPcn179nxNTQJc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <h4>BBC & ITV Fast Fashion Reports</h4>
            <p>Learn about the dangers in fast fashion and how we can improve</p>
            <iframe width="85%" height="315" src="https://www.youtube-nocookie.com/embed/7i0QMnz4ExY?si=sTF6T0EGUnNGn3Ht" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <iframe width="85%" height="315" src="https://www.youtube-nocookie.com/embed/YnKEJprS3xM?si=5Z1LEycPNzDST1R5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
